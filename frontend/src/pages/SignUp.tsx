...
import { NotebookPen, User, Mail, Lock, ArrowRight } from 'lucide-react'
      ...
      <div className="w-full h-[calc(100vh-1.5rem)] md:h-[calc(100vh-3rem)] rounded-2xl overflow-hidden flex shadow-[0_20px_60px_-15px_rgba(192,69,58,0.35)]">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center px-8 py-12 bg-white overflow-y-auto">
          <div className="w-full max-w-sm">
            <h2 className="text-3xl font-semibold text-[#1D2939] mb-1">Create your account</h2>
            <p className="text-sm text-gray-500 mb-8">Free to start. No credit card needed.</p>
            ...
            <p className="text-sm text-gray-500 text-center mt-8">
              ...
              <Link to="/login" className="text-[#C0453A] font-medium">
                Log in
              </Link>
            </p>
          </div>
